 ...
 */
var tags = ['india','usa','Messi','Pele','Maradona','biography'];
...
var footballArticles = [
                       {'tags': [tags[0],tags[3]], 'title' : 'Messi', 'image': 'images/football/messi.png', 'text' : articleText[0], 'author' : 'Hareesh Bhimani', 'date' : '1st June 2013'},
                       {'tags': [tags[0],tags[1],tags[2]], 'title' : 'World Cup 1983', 'image': 'images/football/fifa1983.jpg', 'text' : articleText[1], 'author' : 'Pankaj Kapur', 'date' : '2nd April 2014'},
                       {'tags': [tags[1]], 'title' : 'USA Soccer history', 'image': 'images/football/soccerUSA.jpg', 'text' : articleText[2], 'author' : 'Steve Brenner', 'date' : '9th November 2015'},
                       {'tags': [tags[0]], 'title' : 'Indian Soccer Journey', 'image': 'images/football/soccerIndia.jpg', 'text' : articleText[3], 'author' : 'Steve Brenner', 'date' : '9th November 2015'},
                       {'tags': [tags[2],tags[5]], 'title' : 'Biography : Maradona', 'image': 'images/football/maradona.jpg', 'text' : articleText[4], 'author' : 'Suneel Wiki', 'date' : '9th November 2015'}
                       ]